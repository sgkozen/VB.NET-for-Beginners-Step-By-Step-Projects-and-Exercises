Public Class OrdersAndInventory
    Private Sub OrdersAndInventory_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnOutOfStock_Click(sender As Object, e As EventArgs) Handles btnOutOfStock.Click
        ...
        lstOutput.Items.Add("These are the items that need to be reordered.")
        lstOutput.Items.Add("The number shows the current inventory for the item.")
