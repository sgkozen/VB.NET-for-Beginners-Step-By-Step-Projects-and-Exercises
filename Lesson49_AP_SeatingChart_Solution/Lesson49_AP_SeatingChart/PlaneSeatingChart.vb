...
Public Class PlaneSeatingChart
    ...
    Private Sub PlaneSeatingChart_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Assign(seat As Integer)
        ...
        If row > 0 Then
            ...
            UpdateRow(row)
            lstRows.Items(row) = " " & seats(row, 1) & seats(row, 2) & seats(row, 3) & "        " & seats(row, 4) & seats(row, 5) & seats(row, 6) & "   "
        End If
    End Sub
    ...
    Private Sub btnDisplay_Click(sender As Object, e As EventArgs) Handles btnDisplay.Click
        ...
        lstDisplay.Items.Add("Window seats available: " & window)
